  ...
  return (
    <div>
      <h2 id="customer-heading">
        <Translate contentKey="ncsInterviewApp.customer.home.title">Customers</Translate>
          ...
          {customerList && customerList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('customerId')}>
                    <Translate contentKey="ncsInterviewApp.customer.customerId">Customer Id</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('firstName')}>
                    <Translate contentKey="ncsInterviewApp.customer.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('middleName')}>
                    <Translate contentKey="ncsInterviewApp.customer.middleName">Middle Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('lastName')}>
                    <Translate contentKey="ncsInterviewApp.customer.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('dateOfBirth')}>
                    <Translate contentKey="ncsInterviewApp.customer.dateOfBirth">Date Of Birth</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('emailId')}>
                    <Translate contentKey="ncsInterviewApp.customer.emailId">Email Id</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('phoneNumber')}>
                    <Translate contentKey="ncsInterviewApp.customer.phoneNumber">Phone Number</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="ncsInterviewApp.customer.home.notFound">No Customers found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
