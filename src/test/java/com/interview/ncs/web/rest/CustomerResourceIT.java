...
import com.interview.ncs.service.CustomerService;
...
public class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL_ID = ">@&q.E\"bt";
    private static final String UPDATED_EMAIL_ID = "Q9^O$@y_%&+.r,";

    private static final String DEFAULT_PHONE_NUMBER = "4084301405";
    private static final String UPDATED_PHONE_NUMBER = "+16 90344634";
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getEmailId()).isEqualTo(DEFAULT_EMAIL_ID);
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getEmailId()).isEqualTo(UPDATED_EMAIL_ID);
